...
const { getBooks, getBookReviews, modifyReview, deleteReview, addReview } = require("../controllers/bookController");
...
bookRouter.post("/reviews/:isbn", authenticate, addReview);
